...
from services.finance_analyzer.categories import get_monthly_data_by_categories
...
async def monthly_expenses_by_categories(
    ...
    monthly_expenses_by_categories = get_monthly_data_by_categories(
...
async def monthly_income_by_categories(
    ...
    monthly_income_by_categories = get_monthly_data_by_categories(monthly_income_data)
